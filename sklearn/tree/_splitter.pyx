    ...
    while (f_i > n_total_constants and  # Stop early if remaining features
        ...
        for i in range(n_searches):
            ...
            while p < end_non_missing:
                ...
                current_proxy_improvement = criterion.proxy_impurity_improvement()*feature_weight[current_split.pos]
...
cdef class BestSplitter(Splitter):
    ...
    cdef int init(
        ...
        Splitter.init(self, X, y, sample_weight, missing_values_in_feature_mask, feature_weight)
